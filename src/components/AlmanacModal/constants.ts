...
import { ALMANAC_ENEMIES_GENERIC_TYPES, ENEMIES } from "../../entities/enemies";
import { CREATURE_TO_IMG_MAP } from "../../constants/creatures";

export const DISABLE_TEXT = "Эта страница пока что недоступна";
export const DEFAULT_PAGE_DISPLAY_AMOUNT = 2;
export const MAX_PAGE_COUNTER = 2;
