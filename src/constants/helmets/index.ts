...
export const ARMORS_TIER_1 = [GALVION_TIER_1, HJELM_TIER_1];
export const ARMORS_TIER_2 = [ALTYN_TIER_1, MASKA_TIER_1];
export const ARMORS_TIER_3 = [RONIN_HELMET_TIER_1, RONIN_RESPIRATOR_TIER_1];

export const RARE_ARMORS_TIER_1 = [GALVION_TIER_2, HJELM_TIER_2];
export const RARE_ARMORS_TIER_2 = [ALTYN_TIER_2, MASKA_TIER_2];
export const RARE_ARMORS_TIER_3 = [
  RONIN_HELMET_TIER_2,
  RONIN_RESPIRATOR_TIER_2,
];

export const SUPER_RARE_ARMORS_TIER_1 = [GALVION_TIER_3, HJELM_TIER_3];
export const SUPER_RARE_ARMORS_TIER_2 = [ALTYN_TIER_3, MASKA_TIER_3];
export const SUPER_RARE_ARMORS_TIER_3 = [
  RONIN_HELMET_TIER_3,
