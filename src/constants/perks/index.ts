...
export const SNIPER_PERKS_DESCRIPTIONS = {
  ...
  [SNIPER_PERKS.INSTAKILL]:
    "Активная: с 25% шансом следующая атака убьет врага с одного удара - перезарядка два хода (кроме боссов, боссы получают дополнительно +15% урона при такой атаке)",
