...
export enum FLAGS {
  ...
  INTRO_SHOWED = "INTRO_SHOWED",
  ACT_1_SHOWED = "ACT_1_SHOWED",
  ACT_2_SHOWED = "ACT_2_SHOWED",
  ENDING_SHOWED = "ENDING_SHOWED",
}

export const DEFAULT_BAG_SIZE = 8;

export const FIRST_TIER_DUNGEONS_AMOUNT = 5;
export const SECOND_TIER_DUNGEONS_AMOUNT = FIRST_TIER_DUNGEONS_AMOUNT * 2;
export const THIRD_TIER_DUNGEONS_AMOUNT =
  FIRST_TIER_DUNGEONS_AMOUNT + SECOND_TIER_DUNGEONS_AMOUNT;
